...
<body>
    ...
    <div class="container">
        <form class="login-form" action="../actions/register.php" method="POST">
            <h2>Ｓｉｇｎ－Ｕｐ</h2>
            <div class="form-group">
                <input type="text" id="username" name="username" placeholder="Username" required>
                <img src="eicon.svg" class="icon" alt="Email Icon">
            </div>
            <div class="form-group">
            ...
            <div class="sign-up">
                Already have an account? <a href="../candidate/clogin.php">Log-In</a>
            </div>
        </form>
    </div>
